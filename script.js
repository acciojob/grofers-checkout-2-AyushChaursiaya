...
function addTotalRow() {
  ...
  const priceElements = document.querySelectorAll('[data-ns-test="price"]'); // Updated attribute
  ...
  newCell.setAttribute('data-ns-test', 'grandTotal'); // Ensure this matches the test attribute
